...
function add_delays {
    ...
    ./container_tc.sh capture-042-apachessl_apache_1 $DELAY1
    ./container_tc.sh capture-042-apachessl_wget_80_1 $DELAY2
    ./container_tc.sh capture-042-apachessl_wget_443_1 $DELAY3
}
